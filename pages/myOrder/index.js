        ...
        <Layout titlePage="Pedidos" search notification menu navbar myOrder="active" >
            <Order>
                ...
                <div className="container-products">
                    <RequestItem value="120" status="Delivered" purchaseDate="03/10/2022" />
                    <RequestItem value="320" previousValue="440.50" status="Pending" purchaseDate="09/10/2022" />
                    <RequestItem value="750,80" status="Cancelled" purchaseDate="14/10/2022" />
                    <RequestItem value="530" status="Processing" purchaseDate="17/10/2022" />
                </div>
            </Order>
        </Layout>
    )
